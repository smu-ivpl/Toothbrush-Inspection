...
def get_hole_distance(getimg, img_draw, closed):
    dimg = getimg.copy()
...
def side_brush(image_path):
    ...
    if num_wpix <= 18 or num_wpix > 4000:
        ...
        fst_pix, last_pix, f_m, s_m, l_m, distance, trim_handle, size_hole = get_hole_distance(morph_thresh_post,
                                                                                               img_draw, closed)
        ...
        cv2.line(brush_draw1, (int(f_m) + pad - fst_pix, brush_draw1.shape[0] - 80),
                 (int(f_m) + pad - fst_pix, brush_draw1.shape[0] - 80), (0, 0, 255), 5)
        cv2.line(brush_draw1, (int(s_m) + pad - fst_pix, brush_draw1.shape[0] - 80),
                 (int(s_m) + pad - fst_pix, brush_draw1.shape[0] - 80), (0, 0, 255), 5)
        ...
        cv2.line(brush_draw2, (int(f_m) + pad - fst_pix, brush_draw2.shape[0] - 80),
                 (int(f_m) + pad - fst_pix, brush_draw2.shape[0] - 80), (0, 0, 255), 5)
        cv2.line(brush_draw2, (int(s_m) + pad - fst_pix, brush_draw2.shape[0] - 80),
                 (int(s_m) + pad - fst_pix, brush_draw2.shape[0] - 80), (0, 0, 255), 5)
